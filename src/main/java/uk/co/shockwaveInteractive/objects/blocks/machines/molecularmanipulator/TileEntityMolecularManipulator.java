...
//
//public class TileEntityMolecularManipulator extends TileEntity implements IInventory, ITickable
//{
...
//	{
//		return this.hasCustomName() ? this.customName : "container.molecular_manipulator";
//	}
//
//	@Override
...
//
//	/*
//	 *	Sets the inventory slots contents
//	 */
//	@Override
...
//		{
//			// 2 ,3 4th input stacks are created
//			ItemStack stack1 = (ItemStack)this.inventory.get(index + 1);
//			this.totalCraftTime = this.getCraftTime(stack, stack1);
//			this.craftTime = 0;
//			this.markDirty();
//		}
//	}
...
//
//	/*
//	 * Sets up NBT - I think this is properties that items and blocks can have separate from every other version
//	 */
//	@Override
...
//			{
//				if(!this.isBurning() && this.canCraft())
//				{
...
//					{
//						this.craftTime = 0;
//						this.totalCraftTime = this.getCraftTime((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
//						this.craftItem();
//						flag1 = true;
//					}
//				}
...
//			}
//			else if(!this.isBurning() && this.craftTime > 0)
//			{
...
//			{
//				flag1 = true;
//				BlockMolecularManipulator.setState(this.isBurning(), this.world, this.pos);
//			}
//		}
//		if(flag1) this.markDirty();
//	}
//
//	public int getCraftTime(ItemStack input1, ItemStack input2)
//	{
//		return 300;
//	}
//
...
//		else
//		{
//			ItemStack result = MolecularManipulatorRecipes.getInstance().getMolecularManipulatorResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
...
//			ItemStack result = MolecularManipulatorRecipes.getInstance().getMolecularManipulatorResult(input1, input2);
//			ItemStack output = (ItemStack)this.inventory.get(3);
//
...
//			if (item == Items.LAVA_BUCKET) return 6000;
...
//	{
//		return "shockmetal:molecular_manipulator";
//	}
//
//	@Override
