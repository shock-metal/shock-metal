...
@OnlyIn(Dist.CLIENT)
public class VacuumMinecartRenderer<T extends AbstractMinecartEntity> extends EntityRenderer<T> {
...
//    private static final ResourceLocation MINECART_TEXTURES = new ResourceLocation("textures/entity/minecart.png");
    ...
    public VacuumMinecartRenderer(EntityRendererManager renderManagerIn) {
