...
public class ConfigGuiFactory implements IModGuiFactory
{
  ...
  {
    return new ShockMetalConfigGui(parentScreen);
  }
  ...
  //This class inherits from GuiConfig, a specialized GuiScreen designed to display your
	...
	public static class ShockMetalConfigGui extends GuiConfig
	{
		public ShockMetalConfigGui(GuiScreen parentScreen)
		{
            ...
            false, false, I18n.format("gui.shockmetalconfiguration.mainTitle"));
		}
		...
		private static List<IConfigElement> getConfigElements()
		{
			...
			list.add(new DummyCategoryElement("General", "gui.shockmetalconfiguration.ctgy.general", CategoryEntryGeneral.class));
			list.add(new DummyCategoryElement("Mod Integration", "gui.shockmetalconfiguration.ctgy.integration", CategoryEntryOther.class));
			return list;
		}
        ...
        Configuration configuration = ShockMetalConfiguration.getConfig();
        ConfigElement cat_general = new ConfigElement(configuration.getCategory(ShockMetalConfiguration.CATEGORY_NAME_GENERAL));
        ...
        return new GuiConfig(this.owningScreen, propertiesOnThisScreen,
                              ...
                              ShockMetalConfiguration.CATEGORY_NAME_GENERAL,
		...
		public static class CategoryEntryOther extends CategoryEntry
		{
			...
			{
        Configuration configuration = ShockMetalConfiguration.getConfig();
        ConfigElement cat_general = new ConfigElement(configuration.getCategory(ShockMetalConfiguration.CATEGORY_NAME_INTEGRATION));
        List<IConfigElement> propertiesOnThisScreen = cat_general.getChildElements();
        String windowTitle = configuration.toString();

        return new GuiConfig(this.owningScreen, propertiesOnThisScreen,
                             this.owningScreen.modID,
                             ShockMetalConfiguration.CATEGORY_NAME_INTEGRATION,
                             this.configElement.requiresWorldRestart() || this.owningScreen.allRequireWorldRestart,
                             this.configElement.requiresMcRestart() || this.owningScreen.allRequireMcRestart,
                             windowTitle);
        //this is a complicated object that specifies the category's gui screen, to better understand
